    ...
    def _compute_check_in_map_link(self):
        for record in self:
            if record.check_in_latitude and record.check_in_longitude:
                record.check_in_map_link = f"https://maps.google.com/?q={record.check_in_latitude},{record.check_in_longitude}"
            else:
    ...
    def _compute_check_out_map_link(self):
        for record in self:
            if record.check_out_latitude and record.check_out_longitude:
                record.check_out_map_link = f"https://maps.google.com/?q={record.check_out_latitude},{record.check_out_longitude}"
            else:
